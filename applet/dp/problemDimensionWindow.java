  ...
  public problemDimensionWindow(SimplexTool target, String title)
    {
      ...
      reminderCon = new JLabel("2 ile 7 arasýnda:");
	  reminderCon.setOpaque(true);
	  reminderCon.setBackground(Color.white);
      reminderVar = new JLabel("2 ile 7 arasýnda:");
      ...
      outerParent.constrain(top,new JLabel("Kýsýtlayýcý fonksiyon sayýsý:"),0,0,1,1,0,0,5,0);
      outerParent.constrain(top,reminderCon,0,1,1,1);
      outerParent.constrain(top,numConstraints,1,1,1,1);
      
      outerParent.constrain(top,new JLabel("Deðiþken sayýsý:"),0,2,1,1,0,0,5,0);
